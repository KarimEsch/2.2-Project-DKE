...
public class ExGamePlayer extends FileWatcher {
    ...
    protected double[] explorerPositions;
    ...
    protected void writeGameFile(){
        ...
        try{
            ...
            prtln.println("explorer = " + explorerPositions[0] + explorerPositions[1]);
            prtln.close();
            ...
            if (scanner.hasNext()&ourturn){
                ...
                switch(id)
                {
                    ...
                    case "explorer":
                        ...
                        explorerPositions[0] = Double.parseDouble(items[2]);
                        explorerPositions[1] = Double.parseDouble(items[3]);
                        explorerPositions[2] = Double.parseDouble(items[4]);
                        explorerPositions[3] = Double.parseDouble(items[5]);
                        break;
